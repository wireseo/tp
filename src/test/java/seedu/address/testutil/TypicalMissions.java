...
public class TypicalMissions {
    public final static String TEST_MISSION_TITLE = "Fractal Dimensions";
    public final static String TEST_MISSION_DEADLINE = "26-08-2020";
    ...
    public final static String TEST_MISSION_TITLE_DIFF = "Musical Notes";
    public final static String TEST_MISSION_DEADLINE_DIFF = "12-10-2020";
